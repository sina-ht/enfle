 ...
 *
 * Last Modified: Sun Jul 29 03:51:34 2001.
 * $Id: identify.c,v 1.1 2001/07/29 00:38:18 sian Exp $
 *
...
#endif
    if (p->image) {
      show_message("*** p->image != NULL ***\n");
      memory_destroy(p->image);
      show_message("*** memory object p->image destroyed (no problem) ***\n");
    }
