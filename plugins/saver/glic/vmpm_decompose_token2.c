 ...
 * Last Modified: Fri Apr 20 18:44:03 2001.
 * $Id: vmpm_decompose_token2.c,v 1.2 2001/04/21 07:28:07 sian Exp $
 */
...
static VMPMDecomposer plugin = {
  name: "Token2",
  description: "More refined new token shift by 1 symbol decomposer",
  init: init,
  decompose: decompose,
  encode: encode,
  decode: decode,
