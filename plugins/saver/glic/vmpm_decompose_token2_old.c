 ...
 * Last Modified: Tue Aug 28 16:14:08 2001.
 * $Id: vmpm_decompose_token2_old.c,v 1.4 2001/08/29 08:37:57 sian Exp $
 */
...
static VMPMDecomposer plugin = {
  name: "Token2_old",
  description: "Refined new token shift by 1 symbol decomposer",
  init: init,
  decompose: decompose,
  encode: encode,
  decode: decode,
