 ...
 * Last Modified: Tue Aug 28 16:14:23 2001.
 * $Id: vmpm_decompose_token_old.c,v 1.4 2001/08/29 08:37:57 sian Exp $
 */
...
static VMPMDecomposer plugin = {
  name: "Token_old",
  description: "Refined new token half shift decomposer",
  init: init,
  decompose: decompose,
  encode: encode,
  decode: decode,
